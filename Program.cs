...
class Program
{
    ...
    static async Task Main()
    {
        ...
        {
            Console.WriteLine($"[FATAL-UNOBSERVED] {e.Exception}");
            e.SetObserved();
            _ = RestartAsync();
        };

        _conn = ConfigurationManager.ConnectionStrings["myconn"].ConnectionString;
        ...
        {
            Console.WriteLine($"[FATAL-STARTUP] {ex.Message}");
            await RestartAsync();
            return;
        }
        ...
        while (true)
        {
            ...
            {
                Console.WriteLine($"[FATAL-MAIN-LOOP] {ex.Message}");
                await RestartAsync();
                return;
            }
        }
